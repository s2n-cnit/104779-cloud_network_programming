...
class TestPlayer(TestBase):
    ...
    @pytest.mark.order(ORDER.create)
    def test_create_404cat(self: Self, username: str,
                           auth_header: str) -> None:
        d = DATA.copy()
    ...
    @pytest.mark.order(ORDER.create)
    def test_create_404cat_wrong_field(self: Self, username: str,
                                       auth_header: str) -> None:
        d = DATA.copy()
        d.rename(**RENAME)
        d.update(player_role_id=ID_NOT_FOUND)
    ...
    @pytest.mark.order(ORDER.create)
    def test_create_404cat_miss_field(self: Self, username: str,
                                      auth_header: str) -> None:
        d = DATA.copy()
        d.pop(FIELD)
        d.update(player_role_id=ID_NOT_FOUND)
    ...
    @pytest.mark.order(ORDER.create)
    def test_create_404cat_add_field(self: Self, username: str,
                                     auth_header: str) -> None:
        d = DATA.copy()
    ...
    def test_read(self: Self, username: str, auth_header: str) -> None:
        _id = self.get_id(username, REF, string=True, personal=False)
    ...
    def test_update(self: Self, username: str, auth_header: str) -> None:
        d = DATA.copy()
        cat_id = self.get_id(username, REF_PLAYER_ROLE)
        d.update(**UPDATE, player_role_id=cat_id)
    ...
    @pytest.mark.order(ORDER.update)
    def test_update_404cat(self: Self, username: str,
                           auth_header: str) -> None:
        d = DATA.copy()
        d.update(**UPDATE, player_role_id=ID_NOT_FOUND)
        _id = self.get_id(username, REF, string=True)
        res = _u(_j(_id), headers=auth_header, json=d)
        if self.is_admin_ok(username, res):
            self.is_status_404(res, TARGET_PLAYER_ROLE)

    @pytest.mark.order(ORDER.update)
    def test_update_404cat_wrong_field(self: Self, username: str,
                                       auth_header: str) -> None:
        d = DATA.copy()
        d.rename(**RENAME)
        d.update(player_role_id=ID_NOT_FOUND)
    ...
    @pytest.mark.order(ORDER.update)
    def test_update_404cat_add_field(self: Self, username: str,
                                     auth_header: str) -> None:
        d = DATA.copy()
        d.update(player_role_id=ID_NOT_FOUND, **ADD_FIELD)
        _id = self.get_id(username, REF, string=True)
